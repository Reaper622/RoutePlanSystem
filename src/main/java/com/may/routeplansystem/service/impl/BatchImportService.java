...
public class BatchImportService {
    ...
    public void batchImport(MultipartFile mFile, HttpServletRequest request,
                            int questionId, BiConsumer<Workbook, Integer> biConsumer) {
        checkFile(mFile);
        ...
        try {
            ...
            biConsumer.accept(wb, questionId);
